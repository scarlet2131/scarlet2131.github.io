      ...
      <section id="home" className={styles.homeSection}>
          <div className={styles.profileContainer}>
            <div className={styles.imageContainer}>
              <img src="/Internship_Portfolio/images/profile.png" alt="Monisha Ranjan" className={styles.image} />
        ...
        <section id="education" className={styles.educationSection}>
          ...
          <div className={styles.educationGrid}>
            <div className={styles.educationCard}>
              <img src="/Internship_Portfolio/images/iiitg.jpg" alt="IIIT Guwahati" className={styles.educationIcon} />
            ...
            <div className={styles.educationCard}>
              <img src="/Internship_Portfolio/images/lambton_college.jpg" alt="Lambton College" className={styles.educationIcon} />
              <div className={styles.educationInfo}>
          ...
          <div className={styles.codingGrid}>
            <div className={styles.codingProfileCard}>
              <a href="https://leetcode.com/mr_233/" target="_blank" rel="noopener noreferrer">
                <img src="/Internship_Portfolio/images/leetcode.jpg" alt="LeetCode" className={styles.codingProfileImage} />
                <p>LeetCode</p>
              </a>
              <p>Max. Rating: 1609</p>
            </div>
            <div className={styles.codingProfileCard}>
              <a href="https://www.codechef.com/users/mr_2131" target="_blank" rel="noopener noreferrer">
                <img src="/Internship_Portfolio/images/codechef.jpg" alt="CodeChef" className={styles.codingProfileImage} />
                <p>CodeChef</p>
              </a>
              <p>Max. Rating: 1833</p>
            </div>
            <div className={styles.codingProfileCard}>
              <a href="https://codeforces.com/profile/mr_2131" target="_blank" rel="noopener noreferrer">
                <img src="/Internship_Portfolio/images/codeforces.jpg" alt="CodeForces" className={styles.codingProfileImage} />
                <p>CodeForces</p>
              </a>
              <p>Max. Rating: 1495</p>
            </div>
            <div className={styles.codingProfileCard}>
              <a href="https://www.hackerearth.com/@monisha161" target="_blank" rel="noopener noreferrer">
                <img src="/Internship_Portfolio/images/hackerearth.jpg" alt="HackerEarth" className={styles.codingProfileImage} />
                <p>HackerEarth</p>
              </a>
              <p>Max. Rating: 1514</p>
            </div>
            <div className={styles.codingProfileCard}>
              <a href="https://www.hackerrank.com/ranjan_monisha21" target="_blank" rel="noopener noreferrer">
                <img src="/Internship_Portfolio/images/hackerrank.jpg" alt="HackerRank" className={styles.codingProfileImage} />
                <p>HackerRank</p>
              </a>
              <p>Max. Rating: 1729</p>
            </div>
        ...
        <section id="skills" className={styles.skillsSection}>
          ...
          <div className={styles.skillsGrid}>
            ...
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/java.png" alt="Java" className={styles.skillIcon} />
              <h3>Java</h3>
            </div>
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/cplus.jpg" alt="C++" className={styles.skillIcon} />
              <h3>C++</h3>
            </div>
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/python.jpg" alt="Python" className={styles.skillIcon} />
              <h3>Python</h3>
            </div>
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/js.jpg" alt="JavaScript" className={styles.skillIcon} />
              <h3>JavaScript</h3>
            </div>
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/matlab.jpg" alt="Matlab" className={styles.skillIcon} />
              <h3>Matlab</h3>
            </div>
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/php.jpg" alt="PHP" className={styles.skillIcon} />
              <h3>PHP</h3>
            </div>
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/net.jpg" alt=".NET" className={styles.skillIcon} />
              <h3>.NET</h3>
            </div>

            {/* <!-- Back-end Development --> */}
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/django.jpg" alt="Django" className={styles.skillIcon} />
              <h3>Django</h3>
            </div>
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/laravel.jpg" alt="Laravel" className={styles.skillIcon} />
              <h3>Laravel</h3>
            </div>
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/mysql.jpg" alt="MySQL" className={styles.skillIcon} />
              <h3>MySQL</h3>
            </div>
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/mongo.jpg" alt="MongoDB" className={styles.skillIcon} />
              <h3>MongoDB</h3>
            </div>
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/elastic.jpg" alt="ElasticSearch" className={styles.skillIcon} />
              <h3>ElasticSearch</h3>
            </div>
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/spring.jpg" alt="Spring Boot" className={styles.skillIcon} />
              <h3>Spring Boot</h3>
            </div>
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/fastapi.jpg" alt="FastAPI" className={styles.skillIcon} />
              <h3>FastAPI</h3>
            </div>

            {/* <!-- Front-end Development --> */}
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/html.jpg" alt="HTML/CSS" className={styles.skillIcon} />
              <h3>HTML/CSS</h3>
            </div>
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/boot.jpg" alt="Bootstrap" className={styles.skillIcon} />
              <h3>Bootstrap</h3>
            </div>
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/react.jpg" alt="React" className={styles.skillIcon} />
              <h3>React</h3>
            </div>

            {/* <!-- Tools & Frameworks --> */}
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/google.jpg" alt="Google APIs" className={styles.skillIcon} />
              <h3>Google APIs</h3>
            </div>
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/android.jpg" alt="Android" className={styles.skillIcon} />
              <h3>Android</h3>
            </div>
            <div className={styles.skillCard}>
              <img src="/Internship_Portfolio/images/git.jpg" alt="Git" className={styles.skillIcon} />
              <h3>Git</h3>
            </div>
          </div>
        </section>
